...
const sports = [
  { 
    ...
    events: [
      ...
      { id: 'nba-2026-mlk-1', name: "MLK Day: Grizzlies @ Mavericks", date: "Jan 19, 2026" },
      { id: 'nba-2026-mlk-2', name: "MLK Day: Lakers @ Celtics", date: "Jan 19, 2026" },
      { id: 'nba-2026-008', name: "Clippers @ Suns", date: "Jan 25, 2026" },
      { id: 'nba-tx-1', name: "Texas Showdown: Mavericks @ Rockets", date: "Jan 28, 2026" },
      { id: 'nba-co-1', name: "Denver Pride: Nuggets @ Kings", date: "Feb 05, 2026" },
      ...
      { id: 'nba-co-2', name: "Nuggets vs Lakers (Mile High Clash)", date: "Mar 02, 2026" },
  ...
  { 
    ...
    events: [
      { id: 'nfl-2026-w1-kc', name: "Week 1: Ravens @ Chiefs (Kickoff)", date: "Sep 10, 2026" },
      { id: 'nfl-2026-w1-dal', name: "Week 1: Cowboys @ Browns", date: "Sep 13, 2026" },
      { id: 'nfl-2026-w1-phi', name: "Week 1: Packers @ Eagles (Brazil)", date: "Sep 13, 2026" },
      { id: 'nfl-2026-w1-den', name: "Week 1: Broncos @ Raiders", date: "Sep 13, 2026" },
      { id: 'nfl-2026-w2-cin', name: "Week 2: Bengals @ Chiefs", date: "Sep 20, 2026" },
      { id: 'nfl-2026-w2-chi', name: "Week 2: Bears @ Texans", date: "Sep 20, 2026" },
      { id: 'nfl-2026-w3-buf', name: "Week 3: Jaguars @ Bills", date: "Sep 28, 2026" },
      { id: 'nfl-2026-w3-mia', name: "Week 3: Dolphins @ Seahawks", date: "Sep 27, 2026" },
      { id: 'nfl-2026-w4-det', name: "Week 4: Seahawks @ Lions", date: "Oct 05, 2026" },
      { id: 'nfl-2026-w4-sf', name: "Week 4: Patriots @ 49ers", date: "Sep 29, 2026" },
      { id: 'nfl-2026-w5-ny', name: "Week 5: Jets @ Vikings (London)", date: "Oct 11, 2026" },
      { id: 'nfl-2026-w5-dal', name: "Week 5: Cowboys @ Steelers", date: "Oct 11, 2026" },
      { id: 'nfl-2026-w6-chi', name: "Week 6: Jaguars @ Bears (London)", date: "Oct 18, 2026" },
      { id: 'nfl-2026-w6-sea', name: "Week 6: 49ers @ Seahawks", date: "Oct 15, 2026" },
      { id: 'nfl-2026-w7-kc', name: "Week 7: Chiefs @ 49ers", date: "Oct 25, 2026" },
      { id: 'nfl-2026-w7-nyj', name: "Week 7: Jets @ Steelers", date: "Oct 25, 2026" },
      { id: 'nfl-2026-w8-dal', name: "Week 8: Cowboys @ 49ers", date: "Nov 01, 2026" },
      { id: 'nfl-2026-w8-phi', name: "Week 8: Eagles @ Bengals", date: "Oct 29, 2026" },
      { id: 'nfl-2026-w9-buf', name: "Week 9: Dolphins @ Bills", date: "Nov 08, 2026" },
      { id: 'nfl-2026-w9-det', name: "Week 9: Lions @ Packers", date: "Nov 08, 2026" },
      { id: 'nfl-2026-w10-ny', name: "Week 10: Giants @ Panthers (Germany)", date: "Nov 15, 2026" },
      { id: 'nfl-2026-w10-phi', name: "Week 10: Eagles @ Cowboys", date: "Nov 15, 2026" },
      { id: 'nfl-2026-w11-bal', name: "Week 11: Ravens @ Steelers", date: "Nov 22, 2026" },
      { id: 'nfl-2026-w11-kc', name: "Week 11: Chiefs @ Bills", date: "Nov 22, 2026" },
      { id: 'nfl-2026-w12-det', name: "Thanksgiving: Bears @ Lions", date: "Nov 26, 2026" },
      { id: 'nfl-2026-w12-dal', name: "Thanksgiving: Giants @ Cowboys", date: "Nov 26, 2026" },
      { id: 'nfl-2026-w12-mia', name: "Thanksgiving Night: Dolphins @ Packers", date: "Nov 26, 2026" },
      { id: 'nfl-2026-w13-buf', name: "Week 13: Bills @ Lions", date: "Dec 06, 2026" },
      { id: 'nfl-2026-w13-phi', name: "Week 13: Eagles @ Ravens", date: "Dec 06, 2026" },
      { id: 'nfl-2026-w14-det', name: "Week 14: Packers @ Lions", date: "Dec 13, 2026" },
      { id: 'nfl-2026-w14-kc', name: "Week 14: Chargers @ Chiefs", date: "Dec 13, 2026" },
      { id: 'nfl-2026-w15-hou', name: "Week 15: Chiefs @ Texans", date: "Dec 20, 2026" },
      { id: 'nfl-2026-w15-sea', name: "Week 15: Packers @ Seahawks", date: "Dec 20, 2026" },
      { id: 'nfl-2026-w16-kc', name: "Xmas: Chiefs @ Steelers", date: "Dec 25, 2026" },
      { id: 'nfl-2026-w16-bal', name: "Xmas: Ravens @ Texans", date: "Dec 25, 2026" },
      { id: 'nfl-2026-w17-phi', name: "Week 17: Cowboys @ Eagles", date: "Jan 03, 2027" },
      { id: 'nfl-2026-w17-buf', name: "Week 17: Bills @ Jets", date: "Jan 03, 2027" },
      { id: 'nfl-2026-w18-den', name: "Week 18: Broncos @ Chiefs", date: "Jan 10, 2027" },
      { id: 'nfl-2026-w18-sf', name: "Week 18: 49ers @ Cardinals", date: "Jan 10, 2027" },
      { id: 'nfl-2027-wildcard', name: "2027 Wild Card Weekend", date: "Jan 16-18, 2027" },
      { id: 'nfl-2027-divisional', name: "2027 Divisional Round", date: "Jan 23-24, 2027" },
      { id: 'nfl-2027-conference', name: "Conference Championship Sunday", date: "Jan 31, 2027" },
  ...
  { 
    ...
    color: "text-cyan-400", 
    events: [
      { id: 'nhl-2026-winter', name: "Winter Classic: Blues vs Blackhawks", date: "Jan 01, 2026" },
      { id: 'nhl-2026-asg', name: "NHL All-Star Game 2026", date: "Jan 31, 2026" },
      { id: 'nhl-co-1', name: "Avalanche @ Rangers (MSG Clash)", date: "Feb 12, 2026" },
