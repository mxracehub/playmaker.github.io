...
const sports = [
  ...
  { 
    ...
    events: [
      { id: 'nfl-2026-wildcard', name: "Wild Card Weekend: Playoff Kickoff", date: "Jan 10-12, 2026" },
      { id: 'nfl-2026-divisional', name: "Divisional Round: AFC & NFC", date: "Jan 17-18, 2026" },
      { id: 'nfl-2026-conference', name: "Conference Championship Sunday", date: "Jan 25, 2026" },
      { id: 'nfl-sb-lx', name: "Super Bowl LX (New Orleans, LA)", date: "Feb 08, 2026" },
      { id: 'nfl-2026-kickoff', name: "NFL Kickoff: Chiefs vs TBD", date: "Sep 10, 2026" },
      { id: 'nfl-2026-w1-co', name: "Week 1: Broncos @ Raiders", date: "Sep 13, 2026" },
      { id: 'nfl-2026-w4-co', name: "Week 4: Broncos vs Chargers", date: "Oct 04, 2026" },
      { id: 'nfl-2026-intl-london', name: "London Series: Tottenham Stadium", date: "Oct 18, 2026" },
      { id: 'nfl-2026-thanks-1', name: "Thanksgiving Day Football Slate", date: "Nov 26, 2026" },
      { id: 'nfl-2026-xmas', name: "Christmas Day: Friday Football", date: "Dec 25, 2026" },
      { id: 'nfl-2027-wildcard', name: "2027 Wild Card Weekend", date: "Jan 09-11, 2027" },
  ...
  { 
    ...
    color: "text-cyan-400", 
    events: [
      { id: 'nhl-2026-winter', name: "Winter Classic: Blues vs TBD", date: "Jan 01, 2026" },
  ...
  { 
    ...
    events: [
      ...
      { id: 'mlb-ny-sox', name: "Rivalry Week: Yankees @ Red Sox", date: "Apr 10, 2026" },
      { id: 'mlb-co-dodgers', name: "Mile High Series: Rockies vs Dodgers", date: "May 15, 2026" },
      { id: 'mlb-london', name: "MLB London Series: Day 1 (Europe)", date: "Jun 13, 2026" },
      { id: 'mlb-co-july4', name: "Independence Day: Rockies vs Giants (Fireworks)", date: "Jul 04, 2026" },
      { id: 'mlb-2026-allstar', name: "2026 MLB All-Star Game (Atlanta, GA)", date: "Jul 14, 2026" },
      { id: 'mlb-co-final', name: "Final Home Series: Rockies vs Padres", date: "Sep 22, 2026" },
