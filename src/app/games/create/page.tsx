...
const sports = [
  { 
    ...
    events: [
      ...
      { id: 'nba-tx-1', name: "Texas Showdown: Mavericks @ Rockets", date: "Jan 28, 2026" },
      { id: 'nba-2026-009', name: "Timberwolves @ Nuggets", date: "Feb 02, 2026" },
      { id: 'nba-2026-010', name: "Cavaliers @ Knicks", date: "Feb 08, 2026" },
      { id: 'nba-2026-allstar', name: "NBA All-Star Game 2026 (Phoenix)", date: "Feb 15, 2026" },
      { id: 'nba-ny-1', name: "NY Battle: Nets @ Knicks", date: "Feb 20, 2026" },
      { id: 'nba-ca-1', name: "California Dreamin': Kings @ Clippers", date: "Mar 05, 2026" },
      ...
      { id: 'nba-2026-playin', name: "NBA Play-In Tournament", date: "Apr 14-17, 2026" },
      ...
      { id: 'nba-2026-xmas-5', name: "Xmas: Suns @ Grizzlies", date: "Dec 25, 2026" },
    ], 
  ...
  { 
    ...
    color: "text-cyan-400", 
    events: [
      { id: 'nhl-2026-winter-classic', name: "NHL Winter Classic: Blackhawks @ Blues", date: "Jan 01, 2026" },
      { id: 'nhl-2026-allstar-1', name: "NHL All-Star Skills Competition", date: "Jan 30, 2026" },
      { id: 'nhl-2026-allstar-2', name: "NHL All-Star Game 2026", date: "Jan 31, 2026" },
      { id: 'nhl-2026-stadium-series', name: "NHL Stadium Series: MetLife Stadium", date: "Feb 21, 2026" },
      { id: 'nhl-2026-trade-deadline', name: "NHL Trade Deadline Day", date: "Mar 06, 2026" },
      { id: 'nhl-ny-battle', name: "New York Rivalry: Islanders @ Rangers", date: "Mar 12, 2026" },
      { id: 'nhl-can-clash', name: "Canadian Battle: Oilers @ Maple Leafs", date: "Mar 25, 2026" },
      { id: 'nhl-2026-reg-end', name: "NHL Regular Season Finale", date: "Apr 16, 2026" },
      { id: 'nhl-2026-playoffs-begin', name: "Stanley Cup Playoffs: Round 1", date: "Apr 20, 2026" },
      { id: 'nhl-2026-semis', name: "NHL Second Round Showdowns", date: "May 05, 2026" },
      { id: 'nhl-2026-conf-finals', name: "NHL Conference Finals", date: "May 19, 2026" },
      { id: 'nhl-2026-finals-begin', name: "Stanley Cup Final: Game 1", date: "Jun 03, 2026" },
      { id: 'nhl-2026-finals-mid', name: "Stanley Cup Final: Game 4", date: "Jun 10, 2026" },
      { id: 'nhl-2026-finals-end', name: "Stanley Cup Final: Game 7 (Potential)", date: "Jun 18, 2026" },
      { id: 'nhl-2026-draft', name: "2026 NHL Entry Draft", date: "Jun 26-27, 2026" },
      { id: 'nhl-2026-free-agency', name: "NHL Free Agency Frenzy", date: "Jul 01, 2026" },
      { id: 'nhl-2026-kickoff', name: "2026-27 NHL Season Opener", date: "Oct 08, 2026" },
      { id: 'nhl-2026-global-series', name: "NHL Global Series: Europe Games", date: "Nov 12, 2026" },
    ], 
  ...
  { 
    ...
    color: "text-white", 
    events: [
      { id: 's-2026-opening', name: "World Cup 2026: Grand Opening Match", date: "Jun 11, 2026" },
      { id: 's-2026-usmnt-1', name: "World Cup: USMNT vs TBD (Los Angeles, CA)", date: "Jun 12, 2026" },
      { id: 's-2026-ny-match', name: "World Cup: Group Stage (New York/New Jersey)", date: "Jun 13, 2026" },
      { id: 's-2026-mia-match', name: "World Cup: Group Stage (Miami, FL)", date: "Jun 15, 2026" },
      { id: 's-2026-dal-match', name: "World Cup: Group Stage (Dallas, TX)", date: "Jun 17, 2026" },
      { id: 's-2026-usmnt-2', name: "World Cup: USMNT vs TBD (Seattle, WA)", date: "Jun 19, 2026" },
      { id: 's-2026-usmnt-3', name: "World Cup: USMNT vs TBD (Los Angeles, CA)", date: "Jun 25, 2026" },
      { id: 's-2026-r32', name: "World Cup: Round of 32 (USA Locations)", date: "Jun 28 - Jul 03, 2026" },
      { id: 's-2026-r16', name: "World Cup: Round of 16 (USA Locations)", date: "Jul 04 - Jul 07, 2026" },
      { id: 's-2026-qf', name: "World Cup: Quarterfinals (USA Locations)", date: "Jul 09 - Jul 11, 2026" },
      { id: 's-2026-sf', name: "World Cup: Semifinals (USA Locations)", date: "Jul 14 - Jul 15, 2026" },
      { id: 's-2026-final', name: "World Cup 2026 Final (MetLife Stadium, NJ)", date: "Jul 19, 2026" },
      { id: 'mls-2026-open', name: "MLS Opening Day: League Wide Slate", date: "Feb 21, 2026" },
      { id: 'mls-2026-la', name: "El Trafico: LAFC vs LA Galaxy", date: "Mar 14, 2026" },
      { id: 'mls-2026-mia', name: "Miami Showcase: Inter Miami vs TBD", date: "Apr 04, 2026" },
      { id: 'mls-2026-allstar', name: "MLS All-Star Game 2026", date: "Jul 22, 2026" },
      { id: 'mls-2026-leagues', name: "Leagues Cup Final 2026", date: "Aug 15, 2026" },
      { id: 'mls-2026-decision', name: "MLS Decision Day 2026", date: "Oct 18, 2026" },
      { id: 'mls-2026-cup', name: "MLS Cup 2026 Final", date: "Dec 05, 2026" },
      { id: 'nwsl-2026-open', name: "NWSL Opening Weekend", date: "Mar 20, 2026" },
      { id: 'nwsl-2026-final', name: "NWSL Championship 2026", date: "Nov 14, 2026" },
    ], 
  ...
  { 
    ...
    color: "text-blue-500", 
    events: [
      { id: 'mlb-2026-opening', name: "MLB Opening Day: League Wide Slate", date: "Mar 26, 2026" },
      { id: 'mlb-yankees-sox', name: "Rivalry Week: Yankees @ Red Sox", date: "Apr 10, 2026" },
      { id: 'mlb-2026-jackie', name: "Jackie Robinson Day: All Teams", date: "Apr 15, 2026" },
      { id: 'mlb-dodgers-giants', name: "California Clash: Dodgers @ Giants", date: "May 15, 2026" },
      { id: 'mlb-2026-london-1', name: "MLB London Series: Day 1", date: "Jun 13, 2026" },
      { id: 'mlb-2026-london-2', name: "MLB London Series: Day 2", date: "Jun 14, 2026" },
      { id: 'mlb-allstar-hrd', name: "2026 MLB Home Run Derby (Atlanta)", date: "Jul 13, 2026" },
      { id: 'mlb-allstar-game', name: "2026 MLB All-Star Game (Atlanta)", date: "Jul 14, 2026" },
      { id: 'mlb-chicago-showdown', name: "Crosstown Classic: Cubs @ White Sox", date: "Aug 05, 2026" },
      { id: 'mlb-2026-reg-end', name: "MLB Regular Season Finale", date: "Sep 27, 2026" },
      { id: 'mlb-2026-wildcard', name: "MLB Wild Card Series Begins", date: "Sep 29, 2026" },
      { id: 'mlb-2026-alds', name: "AL Division Series Begins", date: "Oct 03, 2026" },
      { id: 'mlb-2026-nlds', name: "NL Division Series Begins", date: "Oct 03, 2026" },
      { id: 'mlb-2026-alcs', name: "AL Championship Series", date: "Oct 12, 2026" },
      { id: 'mlb-2026-nlcs', name: "NL Championship Series", date: "Oct 13, 2026" },
      { id: 'mlb-2026-ws-1', name: "World Series Game 1", date: "Oct 23, 2026" },
      { id: 'mlb-2026-ws-4', name: "World Series Game 4", date: "Oct 27, 2026" },
      { id: 'mlb-2026-ws-7', name: "World Series Game 7 (Potential)", date: "Oct 31, 2026" },
    ], 
