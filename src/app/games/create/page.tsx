...
const sports = [
  { 
    ...
    events: [
      ...
      { id: 'nba-5', name: "Suns @ Nuggets", date: "Jan 25, 2026" },
      { id: 'nba-6', name: "Bulls @ Pistons", date: "Feb 02, 2026" },
      { id: 'nba-7', name: "NBA All-Star 2026", date: "Feb 15, 2026" },
      { id: 'nba-8', name: "Rockets @ Spurs", date: "Mar 14, 2026" },
      { id: 'nba-9', name: "Clippers @ Kings", date: "Mar 18, 2026" },
      { id: 'nba-10', name: "Finals Game 1", date: "Jun 04, 2026" },
      { id: 'nba-ny', name: "Nets @ Knicks (NY Showdown)", date: "Jan 20, 2026" },
      { id: 'nba-ca', name: "Warriors @ Lakers (CA Duel)", date: "Jan 28, 2026" },
      { id: 'nba-tx', name: "Spurs @ Mavericks (TX Battle)", date: "Feb 05, 2026" },
      { id: 'nba-fl', name: "Magic @ Heat (FL Classic)", date: "Feb 12, 2026" },
      { id: 'nba-il', name: "Bulls @ Bucks (Midwest)", date: "Feb 20, 2026" },
      { id: 'nba-pa', name: "76ers @ Raptors (Atlantic)", date: "Mar 02, 2026" },
      { id: 'nba-ga', name: "Hawks @ Hornets (South)", date: "Mar 10, 2026" },
      { id: 'nba-az', name: "Suns @ Clippers (Pacific)", date: "Mar 25, 2026" },
    ], 
  ...
  { 
    ...
    events: [
      ...
      { id: 'nfl-w6', name: "Vikings @ Lions (W6)", date: "Oct 15, 2026" },
      ...
      { id: 'nfl-w14', name: "Dolphins @ Bills (W14)", date: "Dec 10, 2026" },
      { id: 'nfl-w15', name: "Packers @ Bears (W15)", date: "Dec 17, 2026" },
      { id: 'nfl-w16', name: "Christmas Showdown", date: "Dec 25, 2026" },
      { id: 'nfl-w17', name: "Regular Season Finale", date: "Jan 03, 2027" },
      { id: 'nfl-p1', name: "Wild Card Weekend", date: "Jan 09, 2027" },
      { id: 'nfl-p2', name: "Divisional Playoffs", date: "Jan 16, 2027" },
      { id: 'nfl-p3', name: "Championship Sunday", date: "Jan 24, 2027" },
  ...
  { 
    ...
    events: [
      ...
      { id: 'h-4', name: "NHL All-Star Game", date: "Feb 07, 2026" },
      { id: 'h-5', name: "Bruins @ Maple Leafs", date: "Feb 22, 2026" },
      { id: 'h-6', name: "Golden Knights @ Stars", date: "Mar 10, 2026" },
      { id: 'h-7', name: "Hurricanes @ Panthers", date: "Mar 25, 2026" },
      { id: 'h-8', name: "Stanley Cup Playoffs G1", date: "Apr 18, 2026" },
      { id: 'h-9', name: "Conference Finals", date: "May 15, 2026" },
      { id: 'h-10', name: "Stanley Cup Finals G1", date: "Jun 08, 2026" },
      { id: 'h-11', name: "Stanley Cup Finals G7", date: "Jun 22, 2026" },
    ], 
    options: ["Oilers", "Avalanche", "Bruins", "Rangers", "Leafs", "Panthers", "Stars", "Knights", "Hurricanes", "Devils"] 
  },
  { 
    id: 'soccer', 
    name: 'Soccer Arena', 
    ...
    events: [
      ...
      { id: 's-5', name: "World Cup 2026: USA vs England", date: "Jun 18, 2026" },
      { id: 's-6', name: "World Cup 2026: Quarter-Finals", date: "Jul 04, 2026" },
      { id: 's-7', name: "World Cup 2026: Semi-Finals", date: "Jul 12, 2026" },
      { id: 's-8', name: "World Cup 2026: Grand Final", date: "Jul 19, 2026" },
      { id: 's-9', name: "MLS Cup Finale 2026", date: "Dec 05, 2026" },
    ], 
    options: ["Real Madrid", "Barcelona", "Man City", "Liverpool", "PSG", "USA", "England", "Argentina", "France", "Brazil", "Germany"] 
  },
  { 
    id: 'mlb', 
    name: 'MLB Arena', 
    ...
    events: [
      ...
      { id: 'm-3', name: "Dodgers @ Padres", date: "May 10, 2026" },
      { id: 'm-4', name: "MLB All-Star Game", date: "Jul 14, 2026" },
      { id: 'm-5', name: "Field of Dreams Game", date: "Aug 13, 2026" },
      { id: 'm-6', name: "Braves @ Phillies", date: "Sep 20, 2026" },
      { id: 'm-7', name: "ALDS / NLDS Starts", date: "Oct 05, 2026" },
      { id: 'm-8', name: "World Series Game 1", date: "Oct 23, 2026" },
      { id: 'm-9', name: "World Series Game 7 (Final)", date: "Oct 31, 2026" },
    ], 
    options: ["Dodgers", "Yankees", "Braves", "Astros", "Phillies", "Cubs", "Red Sox", "Padres", "Rangers", "Orioles"] 
  },
  { 
    id: 'nascar', 
    name: 'NASCAR Arena', 
    ...
    events: [
      ...
      { id: 'nas-2', name: "Atlanta Speedway", date: "Feb 22, 2026" },
      { id: 'nas-3', name: "Las Vegas Duel", date: "Mar 01, 2026" },
      { id: 'nas-4', name: "Phoenix Raceway", date: "Mar 08, 2026" },
      { id: 'nas-5', name: "Bristol Dirt Race", date: "Mar 15, 2026" },
      { id: 'nas-6', name: "Talladega Superspeedway", date: "Apr 19, 2026" },
      { id: 'nas-7', name: "Dover Motor Speedway", date: "Apr 26, 2026" },
      { id: 'nas-8', name: "Darlington Throwback", date: "May 10, 2026" },
      { id: 'nas-9', name: "All-Star Race (N. Wilkesboro)", date: "May 17, 2026" },
      { id: 'nas-10', name: "Coca-Cola 600 (Charlotte)", date: "May 24, 2026" },
      { id: 'nas-11', name: "Sonoma Road Course", date: "Jun 07, 2026" },
      { id: 'nas-12', name: "Nashville Superspeedway", date: "Jun 28, 2026" },
      { id: 'nas-13', name: "Chicago Street Race", date: "Jul 05, 2026" },
      { id: 'nas-14', name: "Indianapolis Brickyard", date: "Jul 19, 2026" },
      { id: 'nas-15', name: "Watkins Glen", date: "Aug 23, 2026" },
      { id: 'nas-16', name: "Daytona Night Race", date: "Aug 29, 2026" },
      { id: 'nas-17', name: "Southern 500 (Playoffs Start)", date: "Sep 06, 2026" },
      { id: 'nas-18', name: "Talladega Playoffs", date: "Sep 20, 2026" },
      { id: 'nas-19', name: "Homestead-Miami", date: "Oct 25, 2026" },
