...
const sports = [
  ...
  { 
    ...
    events: [
      ...
      { id: 'h-8', name: "Stanley Cup Finals G1", date: "Jun 08, 2026" },
    ], 
  ...
  { 
    ...
    events: [
      ...
      { id: 'm-7', name: "World Series Game 1", date: "Oct 23, 2026" },
      { id: 'm-8', name: "World Series Game 7 (Final)", date: "Oct 31, 2026" },
    ], 
