...
const sports = [
  ...
  { 
    ...
    events: [
      ...
      { id: 'mlb-26-co-02', name: "Rockies vs Diamondbacks (Gm 2)", date: "Apr 04, 2026" },
      { id: 'mlb-26-co-03', name: "Rockies vs Diamondbacks (Gm 3)", date: "Apr 05, 2026" },
      { id: 'mlb-26-ny-01', name: "Yankees @ Red Sox (Fenway Opener)", date: "Apr 10, 2026" },
      { id: 'mlb-26-co-04', name: "Rockies vs Dodgers (Mile High Clash)", date: "Apr 15, 2026" },
      { id: 'mlb-26-co-05', name: "Rockies vs Dodgers (Gm 2)", date: "Apr 16, 2026" },
      ...
      { id: 'mlb-26-co-06', name: "Rockies @ Padres (Petco Park)", date: "May 12, 2026" },
      { id: 'mlb-26-co-07', name: "Rockies vs Giants (Summer Classic)", date: "May 20, 2026" },
      ...
      { id: 'mlb-26-co-08', name: "Rockies vs Phillies (Coors Field)", date: "Jun 10, 2026" },
      { id: 'mlb-26-lon', name: "MLB London Series: Mets vs Phillies", date: "Jun 13, 2026" },
      { id: 'mlb-26-co-09', name: "Rockies vs Giants (July 4th Fireworks)", date: "Jul 04, 2026" },
      { id: 'mlb-26-co-10', name: "Rockies vs Giants (Gm 2)", date: "Jul 05, 2026" },
      { id: 'mlb-26-asg', name: "2026 MLB All-Star Game (Atlanta)", date: "Jul 14, 2026" },
      { id: 'mlb-26-co-11', name: "Rockies @ Rockies @ Dodgers (LA)", date: "Jul 22, 2026" },
      { id: 'mlb-26-co-12', name: "Rockies vs Cubs (Summer Series)", date: "Aug 10, 2026" },
      { id: 'mlb-26-co-13', name: "Rockies vs Cubs (Gm 2)", date: "Aug 11, 2026" },
      ...
      { id: 'mlb-26-co-14', name: "Rockies Regular Season Finale vs Padres", date: "Sep 27, 2026" },
