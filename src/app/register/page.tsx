...
import { Trophy, Mail, Lock, ShieldCheck, ArrowLeft, Loader2, LogOut, Smartphone, ExternalLink, Copy, Check } from "lucide-react";
            ...
            <form onSubmit={handleVerify2FA}>
              <CardContent className="space-y-6">
                <div className="flex flex-col gap-4">
                  <div className="flex flex-col gap-3 p-4 rounded-xl bg-accent/5 border border-accent/20 w-full">
