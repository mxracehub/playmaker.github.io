...
export interface Sport {
  id: string;
  name: string;
  icon: string; // Used for identifying the component to render
  color: string;
  events: SportEvent[];
  options: string[];
}
...
export const sportsData = [
  ...
  { 
    ...
    color: "text-blue-500", 
    events: [
      { id: 'mlb-26-open', name: "MLB Opening Day (League Wide)", date: "Mar 26, 2026" },
      { id: 'mlb-26-co-01', name: "Rockies Home Opener vs D-Backs", date: "Apr 03, 2026" },
      { id: 'mlb-26-co-02', name: "Rockies vs D-Backs (Gm 2)", date: "Apr 04, 2026" },
      { id: 'mlb-26-ny-01', name: "Yankees @ Red Sox (Fenway)", date: "Apr 10, 2026" },
      { id: 'mlb-26-co-03', name: "Rockies vs Dodgers (Mile High)", date: "Apr 15, 2026" },
      { id: 'mlb-26-jackie', name: "Jackie Robinson Day (League Wide)", date: "Apr 15, 2026" },
      { id: 'mlb-26-co-04', name: "Rockies vs Dodgers (Gm 2)", date: "Apr 16, 2026" },
      { id: 'mlb-26-tx-01', name: "Astros vs Rangers (Lone Star)", date: "Apr 24, 2026" },
      { id: 'mlb-26-co-05', name: "Rockies vs Giants (Summer Series)", date: "May 12, 2026" },
      { id: 'mlb-26-co-06', name: "Rockies vs Giants (Gm 2)", date: "May 13, 2026" },
      { id: 'mlb-26-il-01', name: "Crosstown Classic: Cubs vs Sox", date: "May 22, 2026" },
      { id: 'mlb-26-ny-02', name: "Subway Series: Mets vs Yankees", date: "Jun 02, 2026" },
      { id: 'mlb-26-co-07', name: "Rockies vs Phillies (Coors)", date: "Jun 10, 2026" },
      { id: 'mlb-26-lon', name: "MLB London Series: Mets vs Phillies", date: "Jun 13, 2026" },
      { id: 'mlb-26-co-08', name: "Rockies @ Padres (Petco)", date: "Jun 22, 2026" },
      { id: 'mlb-26-co-09', name: "Rockies vs Giants (July 4th)", date: "Jul 04, 2026" },
      { id: 'mlb-26-asg', name: "2026 All-Star Game (Atlanta)", date: "Jul 14, 2026" },
      { id: 'mlb-26-co-10', name: "Rockies vs Cubs (Coors Field)", date: "Aug 10, 2026" },
      { id: 'mlb-26-field', name: "MLB Field of Dreams 2026", date: "Aug 15, 2026" },
      { id: 'mlb-26-co-11', name: "Rockies @ Dodgers (LA)", date: "Sep 01, 2026" },
      { id: 'mlb-26-sept', name: "Pennant Race: Yankees @ Jays", date: "Sep 12, 2026" },
      { id: 'mlb-26-co-12', name: "Rockies Season Finale vs Padres", date: "Sep 27, 2026" },
